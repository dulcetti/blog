  ...
  return (
    <Layout>
      ...
      <S.PageText>
        ...
        ridícula de fora, eu atuo na área de webdesign, design gráfico, há mais de 5 anos. Em todas
        as empresas em que trabalhei, fui o principal responsável pela criação de todos os tipos de
        mídias digitais e impressas, tais como websites, hotsites, folders, banners, outdoors,
        painéis, apresentações.
      </S.PageText>
      ...
      <S.PageText>
        ...
        Multimídia pela UFF em Niterói. Logo após a conclusão do curso, eu arrumei novamente minhas
        malas (pra variar um pouco neh =P sou praticamente um nômade, um cigano =D) mais uma vez e
        voltei pro Rio, minha terra natal e que amo bastante apesar da violência, etc.
      </S.PageText>
      <S.PageSubSubTitle>
        Sucesso total! além de estudar, você também curte essa área de estudos né?
      </S.PageSubSubTitle>
      <S.PageText>
        Sim sim. Seja em fóruns, pelo meu blog, entre outros meios, gosto muito de ajudar os outros.
        Fui instrutor na Formação Webdesigner em Petrópolis, no curso DigiSerra Informática e este
        ano comecei a lecionar o módulo de Flash no curso iLearn. Gosto de dar aulas, relação com
        pessoas e transmitir conhecimentos.
      </S.PageText>
      <S.PageSubSubTitle>Show de bola. Então me ajuda numa parada aqui?</S.PageSubSubTitle>
      <S.PageText>
        Sem exageros ok? Não faço consultoria gratuíta. Eu ajudo e tal, mas como diz um velho dizer
        "Não entrego o peixe, eu ensino a pescar". Essa é minha teoria. Estude, corra atrás, não
        queira tudo na sua mão.
      </S.PageText>
