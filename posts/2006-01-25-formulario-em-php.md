...
category: Back-End
date: 2006-01-25T14:10:45.000Z
description: ''
image: null
slug: formulario-em-php
templateKey: blog-post
title: 'Formulario em PHP'
---

Estava eu tranquilo, quando Leandro Cunha, camaradassa meu me perguntou sobre como fazer um formulário via PHP. Como estava no <a href="http://www.meebo.com">meebo</a> e odeio esses IM via browser, achei melhor postar algo no Blog, com isso, posso ajudar possíveis pessoas que tenham dúvidas sobre o assunto.

É muito simples sua implementação, pra quem já conhece PHP legal, já mexe, isso é mole, mas pro pessoal que tá começando agora, tá no básico ainda, vale ler (eu acho :P)

## Primeira Parte - <acronym title="HyperText Markup Language">HTML</acronym>

Primeiramente, lógico, vou postar um código html de um formulário (lembrando que não coloquei nenhum estilo pro formulário, isso fica com vocês ok? ;) ) <a href="/formulario/formulario.html">ver exemplo online</a>:
...
<form action="enviar_formulario.php" method="post">
  ...
  <label for="mensagem">
    Mensagem:
    <textarea name="mensagem" id="mensagem" cols="32" rows="8"></textarea>
  </label>
...
### Mensagem: `<textarea name="mensagem" id="mensagem" cols="32" rows="8"></textarea>`
...
## Arquivo <a href="/formulario/enviar_formulario.php">enviar_formulario.php</a>
...
$headers = "From: ".$remetente."\nContent-type: text/html"; # o 'text/html' &eacute; o tipo mime da mensagem
...
Temos esse script funcionando na <a href="/contato">seção contato do meu site</a>.
